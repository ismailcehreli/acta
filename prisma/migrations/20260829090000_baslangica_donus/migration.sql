-- Web panelinden güvenli başlangıca dönüş için istek kuyruğu ve ilk giriş
-- parolası değişikliği zorunluluğu.
...
-- Aynı anda yalnızca bir başlangıca dönüş işlemi bekleyebilir veya çalışabilir.
