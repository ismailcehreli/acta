-- Bildirim olaylarının sistem genelinde yönetilmesi ve panelden yedek isteği.
-- Yedek işlemi uygulamayı durdurduğu için web süreci yalnızca bu kuyruğa istek
-- bırakır; host üzerindeki koşucu isteği alır.
...
-- Aynı anda yalnızca bir yedek isteği bekleyebilir ya da çalışabilir.
...
-- Fiziksel silme yoktur; geçmişte hangi yedeğin istendiği korunur.
