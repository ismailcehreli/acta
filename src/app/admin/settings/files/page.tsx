...
export async function generateMetadata() {
  return getLocalizedMetadata("screens.settingsPage.details.filesTitle");
}
...
export default async function FileSettingsPage() {
  ...
  return (
    <SettingsChrome
      user={user}
      section="files"
      title={t("screens.settingsPage.details.filesTitle")}
      description={t("screens.settingsPage.details.filesDescription")}
    >
