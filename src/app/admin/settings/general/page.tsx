...
export async function generateMetadata() {
  return getLocalizedMetadata("screens.settingsPage.details.generalTitle");
}
...
export default async function GeneralSettingsPage() {
  ...
  return (
    <SettingsChrome
      user={user}
      section="general"
      title={t("screens.settingsPage.details.generalTitle")}
      description={t("screens.settingsPage.details.generalDescription")}
    >
